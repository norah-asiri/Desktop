...
class ViewController: UIViewController {
    ...
    @IBAction func nextButtonPressed(_ sender: UIButton) {
        // if currentQuestion is less than the count of quizBank - 1 then currentQuestion++ else set currentQuestion to 0
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        // if answerLabel is not hidden, then make it hiddencopy
